...
public class GameHotkeyController {
    ...
    public ResponseEntity<ApiResponse<?>> list(@RequestHeader("Authorization") String authorizationHeader) {
        ...
        return ResponseEntity.ok(ApiResponse.success(gameHotkeyService.list(accountId)));
    }
    ...
    public ResponseEntity<ApiResponse<?>> set(
        ...
        try {
            String accountId = jwtUtility.extractPlayerAccountId(jwtUtility.extractToken(authorizationHeader));
            return ResponseEntity.ok(ApiResponse.success(gameHotkeyService.set(accountId, keyIndex, request)));
    ...
    public ResponseEntity<ApiResponse<?>> clear(
        ...
        try {
            String accountId = jwtUtility.extractPlayerAccountId(jwtUtility.extractToken(authorizationHeader));
            gameHotkeyService.clear(accountId, keyIndex);
